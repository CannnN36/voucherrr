...
${message.guild.emojiGöster(emojiler.Tag)} Sunucumuz da ${global.sayılıEmoji(message.guild.members.cache.filter(m => m.presence && m.presence.status !== "offline").size)} aktif üye bulunmakta.
